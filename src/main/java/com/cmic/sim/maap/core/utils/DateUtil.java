...
public class DateUtil {
    ...
    /**
     * 获取YYYY-MM-DDTHH:MM:SSZ格式
     *
     * @param date
     * @return
     */
    public static String getGitTime(Date date){
    ...
    /**
     * 用于获取gitlab的commit的created_to的时间，涉及时区
     *
     * @param date
     * @return
     */
    public static Date gitTime(String date){
        return parse(date,"yyyy-MM-dd'T'HH:mm:ss.SSSXXX");
    }
    /**
     * 格式化日期
     *
     ...
     * @return
     */
    public static Date getAfterYear(int years){
...
//        boolean flag=timeCompare(new Date(),getAfterDayDate(-1));
